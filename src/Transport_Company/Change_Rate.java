					...
					public void actionPerformed(ActionEvent arg0) {
						...
						try {
							if(com.if_branch_exists(branchid)){
								int oldrate = com.get_branchrate(branchid);
								com.change_rate(branchid, rate);
								JOptionPane.showMessageDialog(null, "<html>The Rate For The Branch Changed <br> Old Rate = "+oldrate+"<br> New Rate ="+rate+"<br></html>");
								dispose();
							}else{
